  ...
  implements OnInit
{
  ...
  ngOnInit(): void {
    this.author = {
      id: this.collection.owner,
      username: "Loading...",
      avatarUrl: "../../../../assets/img/AvraeSquare.jpg",
    };
    this.loadAuthor();
  }
  ...
  isSubscribed() {
    return this.workshopService.personalSubscribedIds?.includes(
      this.collection._id,
    );
  }
